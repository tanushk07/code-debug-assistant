export default function ErrorLog({ value = '', onChange }) {
  return (
    <div className="border-t-2 border-black flex flex-col">
      <div className="flex items-center bg-gray-50 border-b-2 border-black h-9 px-3">
        <span className="pixel-label">ERROR LOG</span>
      </div>
      <textarea
        className="w-full h-32 p-3 font-mono text-sm bg-white text-black resize-none outline-none"
